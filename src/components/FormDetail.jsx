    ...
    return(
      <div className='px-8 xl:px-3 lg:py-4 sm:p-5      mt-16'>
        <form onSubmit={handleSubmit}>
          ...
          <div className=''>
            <button  className='sm:hover:bg-red-700 py-2  sm:text-[10px] md:py-3  lg:hover:shadow-2xl w-4/5   xl:py-2 xl:text-[16px] lg:mt-2 lg:py-2 lg:text-[16px] rounded-lg mt-3 xl:mt-1 md:mt-2 sm:mt-1 sm:w-full text-center bg-slate-900 text-white font-bold'>Subscribe to monthly newsletter</button>
          </div>
        </form>
      </div>
    )
